...
| &#9744;  <a name="0" href="0">`a59`</a>  RocksettaTinyML   |  [https://github.com/hpssjellis/RocksettaTinyML](https://github.com/hpssjellis/RocksettaTinyML)    |     | Install this Arduino style library by Green Code --> Downlaod Zip,  then on the Arduino IDE go to ```Sketch``` --> ```include library` --> ```Add .zip library``` find the .zipped file in your downloads. Install it and then look for a relevant example.    |
<br><br><br>
