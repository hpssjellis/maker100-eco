...
| &#10004;  <a name="0" href="#0">`0`</a> XiaoEsp32s3 waveshare-greyscale-oled                          |   [seeed-waveshare-grayscale-oled.ino](seeed-sketches/seeed-waveshare-grayscale-oled.ino)        |               |   Get the XIAO Camera working with the Grayscale Waveform 128x128 OLED                      |
| &#10004;  <a name="0" href="#0">`0`</a> XiaoEsp32s3 camera-waveshare-greyscale-oled                          |   [](seeed-sketches/)        |               |   Get the XIAO Camera working with the Grayscale Waveform 128x128 OLED                      |
