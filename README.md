...
|   <a name="a67" href="#a67">`a67`</a>  Easy and Hard pins test   |      |     |Use the RAKClip or Solder wires to the pads on the rak2270 and do some pin testing like you would for an Arduino   |
|   <a name="a68" href="#a68">`a68`</a>  []()   |      |     |    |
...
| Topic | Example Code| Video | Instructions |
|:---|:---|:---|:---|
| <a name="FP1" href="FP1">`FP1`</a>  One sensor with one actuator final project  |      |     |   <details closed> <summary>More Instructions</summary> ... </details> <details closed> <summary>ChatGPT Prompt</summary> ... </details>  |
| <a name="FP2" href="FP2">`FP2`</a>  complex sensor, ML, actuator final project  |      |     |   <details closed> <summary>More Instructions</summary> ... </details> <details closed> <summary>ChatGPT Prompt</summary> ... </details>  |
| <a name="FP3" href="FP3">`FP3`</a>  group final project, proof of concept for a viable product  |      |     |   <details closed> <summary>More Instructions</summary> ... </details> <details closed> <summary>ChatGPT Prompt</summary> ... </details>  |
