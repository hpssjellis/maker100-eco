...
| &#10004  <a name="0" href="0">`0`</a>  Lidar   |  [a99b-lidar-oled.ino](./seeed-sketches
/a99b-lidar-oled.ino)    |     | Connect the Lidar and Grayscale OLED and see if this code works. Power the Lidar seperately from the XIAO until someone says you don't need to  <details closed> <summary>More Instructions</summary> ... </details> <details closed> <summary>ChatGPT Prompt</summary> ... </details>  |
