...
| &#9745;  <a name="a05" href="a05">`a05`</a>  Put the above Vision model on the XiaoEsp32s3  |  [./seeed-sketches/seeed-vision-if-define-XIAO.txt](seeed-vision-if-define-XIAO.txt)    |   [<img src="https://img.youtube.com/vi/i2xg_wxBGdc/hqdefault.jpg" width=600 />](https://www.youtube.com/watch?v=i2xg_wxBGdc&list=PL57Dnr1H_egt9XmHjfcyRR4YCo3eGrZwQ&index=3&pp=iAQB)   |  Set Arduino Tools-->PSRAM-->OPIPSRAM and fix the code so it works for the XIAO-ESP32S3 <details closed> <summary>More Instructions</summary> ... </details> <details closed> <summary>ChatGPT Prompt</summary> ... </details>  |
