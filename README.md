...
| &#9744;  <a name="0" href="0">`a37`</a>  Multiplexer (mux)   |      |     | Connect the XIAO using I2C to a multiplexer a device that allows more pins to be used when your board runs out of pins Typically for a large project   |
| &#9744;  <a name="0" href="0">`a38`</a>  Use a 2nd XIAO as an I2C multiplexer   |  Thanks Leander and Giorgio <br>reciever:  [seeed-i2c-2xiao-receiver.ino](seeed-sketches/seeed-i2c-2xiao-receiver.ino) <br> transmitter [seeed-i2c-2xiao-transmitter.ino](seeed-sketches/seeed-i2c-2xiao-transmitter.ino)   |     | On all XIAO board I2C SDA is D4 and SDC is D5, making these connections really easy. If you want the first board to power the second board just connect GND and 3v3  |
